...
class VegieScanner extends StatefulWidget {
  @override
  _VegieScannerState createState() => _VegieScannerState();
}

class _VegieScannerState extends State<VegieScanner> {
  File _image;
  List _results;
  int ctr=1;
  @override
                                      ...
                                      return Container(
                                        ...
                                        child: GestureDetector(child:Container(
                                          ...
                                          onTap: (){
                                            ...
                                            {
                                              print("yes");
                                              //Navigator.push(context, MaterialPageRoute(builder: (context) => Cabbage()));
                                            }
                                            else if (result["index"]==1)
                                            {
                                              print("yes");
                                              //Navigator.push(context, MaterialPageRoute(builder: (context) => Capsicum()));
                                            }
  ...
  Future loadModel() async {
    ...
    res = await Tflite.loadModel(
      model: "assets/vegies/model_unquant.tflite",
      labels: "assets/vegies/labels.txt",
    );
    print(res);
  }
