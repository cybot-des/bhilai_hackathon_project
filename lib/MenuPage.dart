          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                Icon(Icons.emoji_food_beverage, size: 50.0,),
                //Icon(CupertinoIcons.),
              ],
            )
          ),
                          ...
                          child: Container(
                            ...
                            child:GestureDetector(child:Row(
                              ...
                              children: [
                                ...
                                Text("Scan Food",style:TextStyle(fontFamily: 'Calibri',fontSize: 30,fontWeight:FontWeight.bold))
                              ],
                            ),
                            onTap: (){
                            ...
                            child: Container(
                              ...
                              child:GestureDetector(child:Row(
                                ...
                                children: [
                                  ...
                                  Text("Nutrients",style:TextStyle(fontFamily: 'Calibri',fontSize: 30,fontWeight:FontWeight.bold))
                                ],
                              ),
                              onTap: (){
                            ...
                            child: Container(
                              ...
                              child:GestureDetector(child:Row(
                                ...
                                children: [
                                  ...
                                  Text("Diet Plan",style:TextStyle(fontFamily: 'Calibri',fontSize: 30,fontWeight:FontWeight.bold))
                                ],
                              ),
                              onTap:() {
                                // Navigator.push(context, MaterialPageRoute(
                            ...
                            child: Container(
                                ...
                                child:GestureDetector(child:Row(
                                  ...
                                  children: [
                                    ...
                                    Text("",style:TextStyle(fontFamily: 'Calibri',fontSize: 30,fontWeight:FontWeight.bold))
                                  ],
                                ),
                                  onTap: (){
